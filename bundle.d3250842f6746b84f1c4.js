...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button.svelte-an51mu{position:absolute;top:2.35rem;left:100%;margin-left:0.5rem;display:flex;align-items:center;justify-content:center;width:2rem;height:2rem;border:none;background-color:transparent;font-size:1em;font-family:inherit}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "ol.svelte-1r3t6ui{list-style:none;margin:0.1rem 0;padding:0;position:relative}.indicator.svelte-1r3t6ui{position:absolute;top:0;left:-1.5rem;display:flex;align-items:center;justify-content:center;width:1.5rem;height:2.2rem;border:none;background-color:transparent;margin:0;padding:0;font-size:0.75rem;font-family:inherit}li.svelte-1r3t6ui{display:inline-block;width:1.5rem;height:2rem;border:0.1rem solid grey;margin:0 0.1rem;text-align:center;line-height:2rem;vertical-align:middle}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "main.svelte-k4vp9f{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh}.container.svelte-k4vp9f{position:relative}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "section.svelte-119xhbg{margin-bottom:1rem}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".row.svelte-9qrp3y{margin:0.2rem 0;padding:0;display:flex;justify-content:center}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button.svelte-pev6px{display:flex;align-items:center;justify-content:center;width:1.5rem;height:2.5rem;border:0.1rem solid grey;border-radius:0.3rem;background-color:transparent;margin:0 0.15rem;font-size:1rem;font-family:inherit}button.special.svelte-pev6px{width:2.5rem}button.incorrect.svelte-pev6px{background-color:darkgray}button.letter.svelte-pev6px{background-color:orange}button.position.svelte-pev6px{background-color:green;color:#ffe}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button.svelte-1nsnjsc{position:absolute;left:100%;margin-left:0.5rem;display:flex;align-items:center;justify-content:center;width:2rem;height:2rem;border:none;background-color:transparent;font-size:1em;font-family:inherit}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
let internal_now = is_client
    ? () => window.performance.now()
    : () => Date.now();
let raf = is_client ? cb => requestAnimationFrame(cb) : internal_noop;
 ...
 */
function internal_loop(callback) {
    let task;
    if (tasks.size === 0)
        raf(run_tasks);
    return {
...
function create_animation(node, from, fn, params) {
    ...
    start: start_time = internal_now() + delay, 
    // @ts-ignore todo:
 ...
 */
function internal_setContext(key, context) {
...
function create_in_transition(node, fn, params) {
    ...
    function go() {
        ...
        tick(0, 1);
        const start_time = internal_now() + delay;
        const end_time = start_time + duration;
        if (task)
            task.abort();
        running = true;
        add_render_callback(() => dispatch(node, true, 'start'));
        task = internal_loop(now => {
            if (running) {
                if (now >= end_time) {
                    tick(1, 0);
...
function fly(node, { delay = 0, duration = 400, easing = easing_cubicOut, x = 0, y = 0, opacity = 0 } = {}) {
    const style = getComputedStyle(node);
    const target_opacity = +style.opacity;
    const transform = style.transform === 'none' ? '' : style.transform;
    const od = target_opacity * (1 - opacity);
...
;// CONCATENATED MODULE: ./node_modules/svelte/animate/index.mjs
...
function flip(node, { from, to }, params = {}) {
    ...
    const { delay = 0, duration = (d) => Math.sqrt(d) * 120, easing = easing_cubicOut } = params;
    return {
        delay,
        duration: internal_is_function(duration) ? duration(Math.sqrt(dx * dx + dy * dy)) : duration,
        easing,
        css: (t, u) => {
            const x = u * dx;
            const y = u * dy;
 ...
 * @param {StartStopNotifier=}start start and stop notifications for subscriptions
 */
function store_writable(value, start = internal_noop) {
    let stop;
...
;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/stores.js
...
const createToast = () => {
  const { subscribe, update } = store_writable([])
  let count = 0
  const options = {}
...
;// CONCATENATED MODULE: ./node_modules/svelte/motion/index.mjs
...
function tweened(value, defaults = {}) {
    ...
    function set(new_value, opts) {
        ...
        let started = false;
        let { delay = 0, duration = 400, easing = identity, interpolate = get_interpolator } = internal_assign(internal_assign({}, defaults), opts);
        if (duration === 0) {
            if (previous_task) {
                previous_task.abort();
                previous_task = null;
        ...
        const start = internal_now() + delay;
        let fn;
        task = internal_loop(now => {
            if (now < start)
                return true;
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte.13.css!./node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte
var ToastItem_svelte = __webpack_require__(151);
;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte.13.css!=!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte.13.css!./node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte
...
var ToastItem_svelte_update = injectStylesIntoStyleTag_default()(ToastItem_svelte/* default */.Z, options);




       /* harmony default export */ const src_ToastItem_svelte = (ToastItem_svelte/* default */.Z && ToastItem_svelte/* default.locals */.Z.locals ? ToastItem_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte
/* node_modules\@zerodevx\svelte-toast\src\ToastItem.svelte generated by Svelte v3.55.0 */
...
function create_if_block(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div, "click", /*close*/ ctx[4]),
					listen(div, "keydown", /*keydown_handler*/ ctx[8])
				];
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t1 = space();
			progress_1 = internal_element("progress");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(div1, "mouseleave", /*resume*/ ctx[6])
				];
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte.11.css!./node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte
var SvelteToast_svelte = __webpack_require__(355);
;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte.11.css!=!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte.11.css!./node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte
...
var SvelteToast_svelte_options = {};

SvelteToast_svelte_options.styleTagTransform = (styleTagTransform_default());
SvelteToast_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      SvelteToast_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
SvelteToast_svelte_options.domAPI = (styleDomAPI_default());
SvelteToast_svelte_options.insertStyleElement = (insertStyleElement_default());

var SvelteToast_svelte_update = injectStylesIntoStyleTag_default()(SvelteToast_svelte/* default */.Z, SvelteToast_svelte_options);




       /* harmony default export */ const src_SvelteToast_svelte = (SvelteToast_svelte/* default */.Z && SvelteToast_svelte/* default.locals */.Z.locals ? SvelteToast_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte
/* node_modules\@zerodevx\svelte-toast\src\SvelteToast.svelte generated by Svelte v3.55.0 */
...
function create_each_block(key_1, ctx) {
	...
	let li_outro;
	let rect;
	let stop_animation = internal_noop;
	let current;
	toastitem = new svelte_toast_src_ToastItem_svelte({ props: { item: /*item*/ ctx[5] } });
	...
	return {
		...
		c() {
			...
			t = space();
			attr(li, "class", li_class_value = "" + (null_to_empty(/*item*/ ctx[5].classes.join(' ')) + " svelte-yh90az"));
			attr(li, "style", li_style_value = /*getCss*/ ctx[1](/*item*/ ctx[5].theme));
			this.first = li;
		},
		m(target, anchor) {
...
function SvelteToast_svelte_create_fragment(ctx) {
	let ul;
	let each_blocks = [];
...
function SvelteToast_svelte_instance($$self, $$props, $$invalidate) {
	let $toast;
...
class SvelteToast extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, SvelteToast_svelte_instance, SvelteToast_svelte_create_fragment, safe_not_equal, { options: 2, target: 3 });
	}
}

/* harmony default export */ const svelte_toast_src_SvelteToast_svelte = (SvelteToast);

;// CONCATENATED MODULE: ./node_modules/@zerodevx/svelte-toast/src/index.js



// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/svelte-simple-modal/src/Modal.svelte.10.css!./node_modules/svelte-simple-modal/src/Modal.svelte
var Modal_svelte = __webpack_require__(855);
;// CONCATENATED MODULE: ./node_modules/svelte-simple-modal/src/Modal.svelte.10.css!=!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/node_modules/svelte-simple-modal/src/Modal.svelte.10.css!./node_modules/svelte-simple-modal/src/Modal.svelte
...
var Modal_svelte_options = {};

Modal_svelte_options.styleTagTransform = (styleTagTransform_default());
Modal_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Modal_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Modal_svelte_options.domAPI = (styleDomAPI_default());
Modal_svelte_options.insertStyleElement = (insertStyleElement_default());

var Modal_svelte_update = injectStylesIntoStyleTag_default()(Modal_svelte/* default */.Z, Modal_svelte_options);




       /* harmony default export */ const src_Modal_svelte = (Modal_svelte/* default */.Z && Modal_svelte/* default.locals */.Z.locals ? Modal_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./node_modules/svelte-simple-modal/src/Modal.svelte
...
function Modal_svelte_create_if_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*state*/ ctx[1].closeButton && Modal_svelte_create_if_block_1(ctx);
			...
			if (!mounted) {
				dispose = [
					listen(div1, "introstart", function () {
						if (internal_is_function(/*onOpen*/ ctx[13])) /*onOpen*/ ctx[13].apply(this, arguments);
					}),
					listen(div1, "outrostart", function () {
						if (internal_is_function(/*onClose*/ ctx[14])) /*onClose*/ ctx[14].apply(this, arguments);
					}),
					listen(div1, "introend", function () {
						if (internal_is_function(/*onOpened*/ ctx[15])) /*onOpened*/ ctx[15].apply(this, arguments);
					}),
					listen(div1, "outroend", function () {
						if (internal_is_function(/*onClosed*/ ctx[16])) /*onClosed*/ ctx[16].apply(this, arguments);
					}),
		...
		p(new_ctx, dirty) {
			...
			if (/*state*/ ctx[1].closeButton) {
				if (if_block) {
					...
					if_block = Modal_svelte_create_if_block_1(ctx);
					if_block.c();
					transition_in(if_block, 1);
					if_block.m(div1, t);
				}
...
function Modal_svelte_create_if_block_1(ctx) {
	...
	let if_block_anchor;
	let current;
	const if_block_creators = [create_if_block_2, Modal_svelte_create_else_block];
	const if_blocks = [];
...
function Modal_svelte_create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*Component*/ ctx[2] && Modal_svelte_create_if_block(ctx);
		...
		p(ctx, dirty) {
			if (/*Component*/ ctx[2]) {
				if (if_block) {
					...
					if_block = Modal_svelte_create_if_block(ctx);
					if_block.c();
					transition_in(if_block, 1);
...
function Modal_svelte_bind(Component, props = {}) {
...
function Modal_svelte_instance($$self, $$props, $$invalidate) {
	...
	const baseSetContext = internal_setContext;
 ...
 */
	const open = (NewComponent, newProps = {}, options = {}, callbacks = {}) => {
		$$invalidate(2, Component = Modal_svelte_bind(NewComponent, newProps));
...
/* harmony default export */ const svelte_simple_modal_src_Modal_svelte = (Modal);


;// CONCATENATED MODULE: ./node_modules/svelte-simple-modal/src/index.js

/* harmony default export */ const src = (svelte_simple_modal_src_Modal_svelte);


;// CONCATENATED MODULE: ./node_modules/svelte-fa/src/utils.js
...
;// CONCATENATED MODULE: ./node_modules/svelte-fa/src/fa.svelte
/* node_modules\svelte-fa\src\fa.svelte generated by Svelte v3.55.0 */




function fa_svelte_create_if_block(ctx) {
	let svg;
	let g1;
	let g0;
	...
	function select_block_type(ctx, dirty) {
		if (typeof /*i*/ ctx[10][4] == 'string') return fa_svelte_create_if_block_1;
		return fa_svelte_create_else_block;
	}
...
// (89:8) {:else}
function fa_svelte_create_else_block(ctx) {
	let path0;
	let path0_d_value;
...
function fa_svelte_create_if_block_1(ctx) {
	let path;
	let path_d_value;
	let path_fill_value;
...
function fa_svelte_create_fragment(ctx) {
	let if_block_anchor;
	let if_block = /*i*/ ctx[10][4] && fa_svelte_create_if_block(ctx);
		...
		p(ctx, [dirty]) {
			if (/*i*/ ctx[10][4]) {
				if (if_block) {
					...
					if_block = fa_svelte_create_if_block(ctx);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
function fa_svelte_instance($$self, $$props, $$invalidate) {
...
class Fa extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, fa_svelte_instance, fa_svelte_create_fragment, safe_not_equal, {
			class: 0,
			id: 1,
			style: 13,
			icon: 14,
...
/* harmony default export */ const fa_svelte = (Fa);
...
/* harmony default export */ const Game_Guess = (Guess);

;// CONCATENATED MODULE: ./src/Game/buildGuesses.ts

const buildGuesses = (count) => {
    const guesses = [];
    for (let i = 0; i < count; i += 1) {
        guesses.push(new Game_Guess());
    }
    return guesses;
};
/* harmony default export */ const Game_buildGuesses = (buildGuesses);
...
class Game {
    constructor() {
        this.guesses = Game_buildGuesses(GUESS_COUNT);
        this.state = GameState.Unknown;
    }
    get word() { return this.currentWord; }
    get isComplete() { return this.isCorrect || this.isIncorrect; }
    get isInProgess() { return this.state === GameState.InProgress; }
    get isCorrect() { return this.state === GameState.CompleteCorrect; }
    get isIncorrect() { return this.state === GameState.CompleteIncorrect; }
    get guessesRemaining() { return GUESS_COUNT - this.guessesTaken; }
    get guessesTaken() { return this.guessIndex + 1; }
    get currentGuessIndex() { return this.guessIndex; }
    get previousGuesses() {
    ...
    get guessMaxCount() { return GUESS_COUNT; }
    // eslint-disable-next-line class-methods-use-this
    get wordLength() { return WORD_LENGTH; }
    startNew() {
        // TODO: close down current game (if there is one)
        this.currentWord = Game_getRandomWord();
        this.guessIndex = 0;
        this.guesses = Game_buildGuesses(GUESS_COUNT);
    ...
    makeGuess(input) {
        ...
        if (!Game_validateWord(uppercaseInput)) {
...
;// CONCATENATED MODULE: ./src/stores/gameStore.ts



const game = new Game_Game();
const createGameStore = () => {
    const initialValue = JSON.parse(localStorage.getItem(GAME_KEY));
    if (initialValue) {
    ...
    const { update, subscribe } = store_writable(game.toJson());
    subscribe((val) => {
        localStorage.setItem(GAME_KEY, JSON.stringify(val));
    });
    return {
        subscribe,
        isInProgress: () => game.isInProgess,
        ...
        getWord: () => game.word,
        getGuesses: () => game.previousGuesses,
        getGuessIndex: () => game.currentGuessIndex,
        getGuessMaxCount: () => game.guessMaxCount,
        getWordLength: () => game.wordLength,
        getKeyResults: () => game.keyResults,
    };
};
...
var StateButton_svelte_options = {};

StateButton_svelte_options.styleTagTransform = (styleTagTransform_default());
StateButton_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      StateButton_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
StateButton_svelte_options.domAPI = (styleDomAPI_default());
StateButton_svelte_options.insertStyleElement = (insertStyleElement_default());

var StateButton_svelte_update = injectStylesIntoStyleTag_default()(StateButton_svelte/* default */.Z, StateButton_svelte_options);




       /* harmony default export */ const components_StateButton_svelte = (StateButton_svelte/* default */.Z && StateButton_svelte/* default.locals */.Z.locals ? StateButton_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/StateButton.svelte
/* src\components\StateButton.svelte generated by Svelte v3.55.0 */
...
function StateButton_svelte_create_fragment(ctx) {
	let button;
	let fa;
	let current;
	let mounted;
	let dispose;
	fa = new fa_svelte({ props: { icon: faSquarePlus } });

	return {
		c() {
			button = internal_element("button");
			create_component(fa.$$.fragment);
			attr(button, "class", "svelte-1nsnjsc");
		},
		m(target, anchor) {
			insert(target, button, anchor);
			...
			if (!mounted) {
				dispose = listen(button, "click", /*handleReset*/ ctx[0]);
				mounted = true;
			}
		},
		p: internal_noop,
...
function StateButton_svelte_instance($$self, $$props, $$invalidate) {
	let { isInProgress } = $$props;
	...
	$$self.$$set = $$props => {
		if ('isInProgress' in $$props) $$invalidate(1, isInProgress = $$props.isInProgress);
	};

	return [handleReset, isInProgress];
}

class StateButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, StateButton_svelte_instance, StateButton_svelte_create_fragment, safe_not_equal, { isInProgress: 1 });
	}
}
...
var ConcedeButton_svelte_options = {};

ConcedeButton_svelte_options.styleTagTransform = (styleTagTransform_default());
ConcedeButton_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      ConcedeButton_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
ConcedeButton_svelte_options.domAPI = (styleDomAPI_default());
ConcedeButton_svelte_options.insertStyleElement = (insertStyleElement_default());

var ConcedeButton_svelte_update = injectStylesIntoStyleTag_default()(ConcedeButton_svelte/* default */.Z, ConcedeButton_svelte_options);




       /* harmony default export */ const components_ConcedeButton_svelte = (ConcedeButton_svelte/* default */.Z && ConcedeButton_svelte/* default.locals */.Z.locals ? ConcedeButton_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/ConcedeButton.svelte
/* src\components\ConcedeButton.svelte generated by Svelte v3.55.0 */
...
function ConcedeButton_svelte_create_fragment(ctx) {
	let button;
	let fa;
	...
	let mounted;
	let dispose;
	fa = new fa_svelte({ props: { icon: faFlag } });

	return {
		c() {
			button = internal_element("button");
			create_component(fa.$$.fragment);
			button.disabled = button_disabled_value = !/*isInProgress*/ ctx[0];
			attr(button, "class", "svelte-an51mu");
		},
		m(target, anchor) {
			insert(target, button, anchor);
			mount_component(fa, button, null);
			...
			if (!mounted) {
				dispose = listen(button, "click", /*handleConcede*/ ctx[1]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
			if (!current || dirty & /*isInProgress*/ 1 && button_disabled_value !== (button_disabled_value = !/*isInProgress*/ ctx[0])) {
...
function ConcedeButton_svelte_instance($$self, $$props, $$invalidate) {
	let { isInProgress } = $$props;
	...
	$$self.$$set = $$props => {
		if ('isInProgress' in $$props) $$invalidate(0, isInProgress = $$props.isInProgress);
	};

	return [isInProgress, handleConcede];
}

class ConcedeButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, ConcedeButton_svelte_instance, ConcedeButton_svelte_create_fragment, safe_not_equal, { isInProgress: 0 });
	}
}

/* harmony default export */ const src_components_ConcedeButton_svelte = (ConcedeButton);

;// CONCATENATED MODULE: ./src/services/getDefinition.ts
...
/* harmony default export */ const services_getDefinition = (getDefinition);

;// CONCATENATED MODULE: ./src/components/DefinitionModal.svelte
/* src\components\DefinitionModal.svelte generated by Svelte v3.55.0 */





function DefinitionModal_svelte_create_else_block(ctx) {
	let strong;
	let t0_value = /*definition*/ ctx[2].phonetic + "";
	let t0;
	let t1;
	let p;
	let t2_value = /*definition*/ ctx[2].meaning + "";
	let t2;

	return {
		c() {
			strong = internal_element("strong");
		...
		p(ctx, dirty) {
			if (dirty & /*definition*/ 4 && t0_value !== (t0_value = /*definition*/ ctx[2].phonetic + "")) set_data(t0, t0_value);
			if (dirty & /*definition*/ 4 && t2_value !== (t2_value = /*definition*/ ctx[2].meaning + "")) set_data(t2, t2_value);
		},
		d(detaching) {
...
// (15:2) {#if loading}
function DefinitionModal_svelte_create_if_block(ctx) {
	let t;

	return {
		c() {
			t = internal_text("Loading");
		},
		m(target, anchor) {
			insert(target, t, anchor);
		},
...
function DefinitionModal_svelte_create_fragment(ctx) {
	let h3;
	let t0;
	let t1;
	let if_block_anchor;
	...
	function select_block_type(ctx, dirty) {
		if (/*loading*/ ctx[1]) return DefinitionModal_svelte_create_if_block;
		return DefinitionModal_svelte_create_else_block;
	}
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*word*/ 1) set_data(t0, /*word*/ ctx[0]);
...
function DefinitionModal_svelte_instance($$self, $$props, $$invalidate) {
	let { word } = $$props;
	let loading = true;
	let definition;
	...
	onMount(async () => {
		...
		$$invalidate(2, definition = await services_getDefinition(word));
	...
	return [word, loading, definition];
}

class DefinitionModal extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, DefinitionModal_svelte_instance, DefinitionModal_svelte_create_fragment, safe_not_equal, { word: 0 });
	}
}
...
var DefinitionButton_svelte_options = {};

DefinitionButton_svelte_options.styleTagTransform = (styleTagTransform_default());
DefinitionButton_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      DefinitionButton_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
DefinitionButton_svelte_options.domAPI = (styleDomAPI_default());
DefinitionButton_svelte_options.insertStyleElement = (insertStyleElement_default());

var DefinitionButton_svelte_update = injectStylesIntoStyleTag_default()(DefinitionButton_svelte/* default */.Z, DefinitionButton_svelte_options);




       /* harmony default export */ const components_DefinitionButton_svelte = (DefinitionButton_svelte/* default */.Z && DefinitionButton_svelte/* default.locals */.Z.locals ? DefinitionButton_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/DefinitionButton.svelte
/* src\components\DefinitionButton.svelte generated by Svelte v3.55.0 */
...
function DefinitionButton_svelte_create_fragment(ctx) {
	let button;
	let fa;
	let current;
	let mounted;
	let dispose;
	fa = new fa_svelte({ props: { icon: faQuestionCircle } });
...
function DefinitionButton_svelte_instance($$self, $$props, $$invalidate) {
	const { open } = getContext('simple-modal');
	let { word } = $$props;

	const handleClick = () => {
		open(DefinitionModal_svelte, { word });
	};
	...
	return [handleClick, word];
}

class DefinitionButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, DefinitionButton_svelte_instance, DefinitionButton_svelte_create_fragment, safe_not_equal, { word: 1 });
	}
}
...
var Guess_svelte_options = {};

Guess_svelte_options.styleTagTransform = (styleTagTransform_default());
Guess_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Guess_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Guess_svelte_options.domAPI = (styleDomAPI_default());
Guess_svelte_options.insertStyleElement = (insertStyleElement_default());

var Guess_svelte_update = injectStylesIntoStyleTag_default()(Guess_svelte/* default */.Z, Guess_svelte_options);




       /* harmony default export */ const components_Guess_svelte = (Guess_svelte/* default */.Z && Guess_svelte/* default.locals */.Z.locals ? Guess_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/Guess.svelte
/* src\components\Guess.svelte generated by Svelte v3.55.0 */





function Guess_svelte_get_each_context(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[2] = list[i];
	return child_ctx;
}
...
function Guess_svelte_create_if_block(ctx) {
	...
	definitionbutton = new src_components_DefinitionButton_svelte({
			props: {
				word: /*result*/ ctx[0].map(func).join('')
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			const definitionbutton_changes = {};
			if (dirty & /*result*/ 1) definitionbutton_changes.word = /*result*/ ctx[0].map(func).join('');
			definitionbutton.$set(definitionbutton_changes);
		},
		i(local) {
			if (current) return;
...
function Guess_svelte_create_each_block(ctx) {
	...
	let t;
	let li_data_position_value;
	let li_data_letter_value;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*result*/ 1 && t_value !== (t_value = /*item*/ ctx[2].letter + "")) set_data(t, t_value);

			if (dirty & /*result*/ 1 && li_data_position_value !== (li_data_position_value = /*item*/ ctx[2].correctPosition)) {
				attr(li, "data-position", li_data_position_value);
			}

			if (dirty & /*result*/ 1 && li_data_letter_value !== (li_data_letter_value = /*item*/ ctx[2].correctLetter)) {
				attr(li, "data-letter", li_data_letter_value);
			}
		},
		d(detaching) {
			if (detaching) detach(li);
...
function Guess_svelte_create_fragment(ctx) {
	let ol;
	let t;
	let current;
	let if_block = /*result*/ ctx[0].length && Guess_svelte_create_if_block(ctx);
	let each_value = /*result*/ ctx[0];
	let each_blocks = [];

	for (let i = 0; i < each_value.length; i += 1) {
		each_blocks[i] = Guess_svelte_create_each_block(Guess_svelte_get_each_context(ctx, each_value, i));
	}

	let each_1_else = null;

	if (!each_value.length) {
		each_1_else = Guess_svelte_create_else_block(ctx);
	}

	return {
		c() {
			ol = internal_element("ol");
			if (if_block) if_block.c();
			t = space();
		...
		p(ctx, [dirty]) {
			if (/*result*/ ctx[0].length) {
				if (if_block) {
					...
					if_block = Guess_svelte_create_if_block(ctx);
					if_block.c();
					transition_in(if_block, 1);
					if_block.m(ol, t);
				}
			...
			if (dirty & /*result, Array, wordLength*/ 3) {
				each_value = /*result*/ ctx[0];
				let i;

				for (i = 0; i < each_value.length; i += 1) {
					const child_ctx = Guess_svelte_get_each_context(ctx, each_value, i);

					if (each_blocks[i]) {
						each_blocks[i].p(child_ctx, dirty);
					} else {
						each_blocks[i] = Guess_svelte_create_each_block(child_ctx);
						each_blocks[i].c();
						each_blocks[i].m(ol, null);
					}
				}
...
const func = i => i.letter;

function Guess_svelte_instance($$self, $$props, $$invalidate) {
	let { result } = $$props;
...
class Guess_svelte_Guess extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, Guess_svelte_instance, Guess_svelte_create_fragment, safe_not_equal, { result: 0 });
	}
}

/* harmony default export */ const src_components_Guess_svelte = (Guess_svelte_Guess);
...
const getLettersPressed = (callback) => {
...
var Current_svelte_options = {};

Current_svelte_options.styleTagTransform = (styleTagTransform_default());
Current_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Current_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Current_svelte_options.domAPI = (styleDomAPI_default());
Current_svelte_options.insertStyleElement = (insertStyleElement_default());

var Current_svelte_update = injectStylesIntoStyleTag_default()(Current_svelte/* default */.Z, Current_svelte_options);




       /* harmony default export */ const components_Current_svelte = (Current_svelte/* default */.Z && Current_svelte/* default.locals */.Z.locals ? Current_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/Current.svelte
/* src\components\Current.svelte generated by Svelte v3.55.0 */
...
function Current_svelte_get_each_context(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[8] = list[i];
	child_ctx[1] = i;
	return child_ctx;
...
// (60:4) {:else}
function Current_svelte_create_else_block(ctx) {
	let li;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*letters*/ 1 && t_value !== (t_value = /*letter*/ ctx[8] + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(li);
		}
...
// (58:4) {#if index === 0}
function Current_svelte_create_if_block(ctx) {
	let li;
	let t_value = /*letter*/ ctx[8] + "";
	let t;
	let mounted;
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(li, "click", /*reset*/ ctx[2]),
					listen(li, "keydown", /*reset*/ ctx[2])
				];
...
// (57:2) {#each letters as letter, index}
function Current_svelte_create_each_block(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*index*/ ctx[1] === 0) return Current_svelte_create_if_block;
		return Current_svelte_create_else_block;
	}
...
function Current_svelte_create_fragment(ctx) {
	let ol;
	let div;
	let fa;
	let t;
	let current;
	fa = new fa_svelte({ props: { icon: faCircleRight } });
	let each_value = /*letters*/ ctx[0];
	let each_blocks = [];

	for (let i = 0; i < each_value.length; i += 1) {
		each_blocks[i] = Current_svelte_create_each_block(Current_svelte_get_each_context(ctx, each_value, i));
	}
	...
	return {
		c() {
			...
			attr(div, "class", "indicator svelte-1r3t6ui");
			attr(ol, "class", "svelte-1r3t6ui");
		},
		m(target, anchor) {
			insert(target, ol, anchor);
			append(ol, div);
		...
		p(ctx, [dirty]) {
			if (dirty & /*reset, letters*/ 5) {
				each_value = /*letters*/ ctx[0];
				let i;

				for (i = 0; i < each_value.length; i += 1) {
					const child_ctx = Current_svelte_get_each_context(ctx, each_value, i);

					if (each_blocks[i]) {
						each_blocks[i].p(child_ctx, dirty);
					} else {
						each_blocks[i] = Current_svelte_create_each_block(child_ctx);
						each_blocks[i].c();
						each_blocks[i].m(ol, null);
					}
				}
...
function Current_svelte_instance($$self, $$props, $$invalidate) {
	const LETTER_COUNT = gameStore.getWordLength();
	const letters = new Array(LETTER_COUNT).fill('');
	let index = 0;

	const reset = () => {
		for (let i = 0; i < LETTER_COUNT; i += 1) {
			$$invalidate(0, letters[i] = '', letters);
		}
	...
	const onLetterPressed = letter => {
		if (index < LETTER_COUNT) {
			$$invalidate(0, letters[index] = letter, letters);
			$$invalidate(1, index += 1);
		}
	};

	const onBackspacePressed = () => {
		$$invalidate(1, index = Math.max(0, index - 1));
		$$invalidate(0, letters[index] = '', letters);
	};
	...
	onMount(() => {
		const clearLetterPressedListener = services_getLettersPressed(onLetterPressed);
		window.addEventListener('keydown', keyPressListener);
	...
	return [letters, index, reset];
}

class Current extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, Current_svelte_instance, Current_svelte_create_fragment, safe_not_equal, {});
	}
}
...
var Guesses_svelte_options = {};

Guesses_svelte_options.styleTagTransform = (styleTagTransform_default());
Guesses_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Guesses_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Guesses_svelte_options.domAPI = (styleDomAPI_default());
Guesses_svelte_options.insertStyleElement = (insertStyleElement_default());

var Guesses_svelte_update = injectStylesIntoStyleTag_default()(Guesses_svelte/* default */.Z, Guesses_svelte_options);




       /* harmony default export */ const components_Guesses_svelte = (Guesses_svelte/* default */.Z && Guesses_svelte/* default.locals */.Z.locals ? Guesses_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/Guesses.svelte
/* src\components\Guesses.svelte generated by Svelte v3.55.0 */





function Guesses_svelte_get_each_context(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[3] = list[i];
	child_ctx[5] = i;
	return child_ctx;
...
// (12:4) {:else}
function Guesses_svelte_create_else_block(ctx) {
	let guess;
	let current;
	guess = new src_components_Guess_svelte({ props: { result: /*result*/ ctx[3] } });
	...
	return {
		...
		m(target, anchor) {
			mount_component(guess, target, anchor);
			current = true;
		},
		p(ctx, dirty) {
			const guess_changes = {};
			if (dirty & /*guessResults*/ 1) guess_changes.result = /*result*/ ctx[3];
		...
		d(detaching) {
			destroy_component(guess, detaching);
		}
	};
}

// (10:4) {#if index === guessIndex && isInProgress}
function Guesses_svelte_create_if_block(ctx) {
	let current;
	let current$1;
	current = new src_components_Current_svelte({});
...
// (9:2) {#each guessResults as result, index}
function Guesses_svelte_create_each_block(ctx) {
	let current_block_type_index;
	let if_block;
	let if_block_anchor;
	let current;
	const if_block_creators = [Guesses_svelte_create_if_block, Guesses_svelte_create_else_block];
	const if_blocks = [];

	function select_block_type(ctx, dirty) {
		if (/*index*/ ctx[5] === /*guessIndex*/ ctx[1] && /*isInProgress*/ ctx[2]) return 0;
		return 1;
	}
...
function Guesses_svelte_create_fragment(ctx) {
	let section;
	let current;
	let each_value = /*guessResults*/ ctx[0];
	let each_blocks = [];

	for (let i = 0; i < each_value.length; i += 1) {
		each_blocks[i] = Guesses_svelte_create_each_block(Guesses_svelte_get_each_context(ctx, each_value, i));
	}
	...
	return {
		c() {
			...
			attr(section, "class", "svelte-119xhbg");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*guessIndex, isInProgress, guessResults*/ 7) {
				each_value = /*guessResults*/ ctx[0];
				let i;

				for (i = 0; i < each_value.length; i += 1) {
					const child_ctx = Guesses_svelte_get_each_context(ctx, each_value, i);

					if (each_blocks[i]) {
						each_blocks[i].p(child_ctx, dirty);
						transition_in(each_blocks[i], 1);
					} else {
						each_blocks[i] = Guesses_svelte_create_each_block(child_ctx);
						each_blocks[i].c();
						transition_in(each_blocks[i], 1);
						each_blocks[i].m(section, null);
					}
...
function Guesses_svelte_instance($$self, $$props, $$invalidate) {
	let { guessResults } = $$props;
	let { guessIndex } = $$props;
	let { isInProgress } = $$props;

	$$self.$$set = $$props => {
		if ('guessResults' in $$props) $$invalidate(0, guessResults = $$props.guessResults);
		if ('guessIndex' in $$props) $$invalidate(1, guessIndex = $$props.guessIndex);
		if ('isInProgress' in $$props) $$invalidate(2, isInProgress = $$props.isInProgress);
	};

	return [guessResults, guessIndex, isInProgress];
}
...
class Guesses extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, Guesses_svelte_instance, Guesses_svelte_create_fragment, safe_not_equal, {
			guessResults: 0,
			guessIndex: 1,
			isInProgress: 2
		});
...
var KeyboardButton_svelte_options = {};

KeyboardButton_svelte_options.styleTagTransform = (styleTagTransform_default());
KeyboardButton_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      KeyboardButton_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
KeyboardButton_svelte_options.domAPI = (styleDomAPI_default());
KeyboardButton_svelte_options.insertStyleElement = (insertStyleElement_default());

var KeyboardButton_svelte_update = injectStylesIntoStyleTag_default()(KeyboardButton_svelte/* default */.Z, KeyboardButton_svelte_options);




       /* harmony default export */ const components_KeyboardButton_svelte = (KeyboardButton_svelte/* default */.Z && KeyboardButton_svelte/* default.locals */.Z.locals ? KeyboardButton_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/KeyboardButton.svelte
/* src\components\KeyboardButton.svelte generated by Svelte v3.55.0 */




function KeyboardButton_svelte_create_else_block(ctx) {
	let t_value = /*button*/ ctx[0].label + "";
	let t;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*button*/ 1 && t_value !== (t_value = /*button*/ ctx[0].label + "")) set_data(t, t_value);
		},
		i: internal_noop,
		o: internal_noop,
		d(detaching) {
...
// (14:2) {#if button.icon}
function KeyboardButton_svelte_create_if_block(ctx) {
	let fa;
	let current;
	fa = new fa_svelte({ props: { icon: /*button*/ ctx[0].icon } });
	...
	return {
		...
		p(ctx, dirty) {
			const fa_changes = {};
			if (dirty & /*button*/ 1) fa_changes.icon = /*button*/ ctx[0].icon;
			fa.$set(fa_changes);
		},
		i(local) {
			if (current) return;
...
function KeyboardButton_svelte_create_fragment(ctx) {
	let button_1;
	let current_block_type_index;
	let if_block;
	let current;
	let mounted;
	let dispose;
	const if_block_creators = [KeyboardButton_svelte_create_if_block, KeyboardButton_svelte_create_else_block];
	const if_blocks = [];

	function select_block_type(ctx, dirty) {
		if (/*button*/ ctx[0].icon) return 0;
		return 1;
	}
	...
	return {
		c() {
			button_1 = internal_element("button");
			if_block.c();
			attr(button_1, "class", "svelte-pev6px");
			toggle_class(button_1, "special", /*button*/ ctx[0].special);
			toggle_class(button_1, "position", /*correctPosition*/ ctx[1]);
			toggle_class(button_1, "letter", /*correctLetter*/ ctx[2]);
			toggle_class(button_1, "incorrect", /*incorrectLetter*/ ctx[3]);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button_1, "click", /*handleClick*/ ctx[4]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*button*/ 1) {
				toggle_class(button_1, "special", /*button*/ ctx[0].special);
			}

			if (!current || dirty & /*correctPosition*/ 2) {
				toggle_class(button_1, "position", /*correctPosition*/ ctx[1]);
			}

			if (!current || dirty & /*correctLetter*/ 4) {
				toggle_class(button_1, "letter", /*correctLetter*/ ctx[2]);
			}

			if (!current || dirty & /*incorrectLetter*/ 8) {
				toggle_class(button_1, "incorrect", /*incorrectLetter*/ ctx[3]);
			}
		},
		i(local) {
...
function KeyboardButton_svelte_instance($$self, $$props, $$invalidate) {
	let { button } = $$props;
	let { correctPosition } = $$props;
	let { correctLetter } = $$props;
	let { incorrectLetter } = $$props;

	const handleClick = () => {
		var _a;

		const keyCode = (_a = button.charCode) !== null && _a !== void 0
		? _a
		: button.label.charCodeAt(0);
	...
	$$self.$$set = $$props => {
		...
		if ('correctPosition' in $$props) $$invalidate(1, correctPosition = $$props.correctPosition);
		if ('correctLetter' in $$props) $$invalidate(2, correctLetter = $$props.correctLetter);
		if ('incorrectLetter' in $$props) $$invalidate(3, incorrectLetter = $$props.incorrectLetter);
	};

	return [button, correctPosition, correctLetter, incorrectLetter, handleClick];
}

class KeyboardButton extends SvelteComponent {
	constructor(options) {
		super();

		init(this, options, KeyboardButton_svelte_instance, KeyboardButton_svelte_create_fragment, safe_not_equal, {
			button: 0,
			correctPosition: 1,
			correctLetter: 2,
			incorrectLetter: 3
...
var Keyboard_svelte_options = {};

Keyboard_svelte_options.styleTagTransform = (styleTagTransform_default());
Keyboard_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Keyboard_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Keyboard_svelte_options.domAPI = (styleDomAPI_default());
Keyboard_svelte_options.insertStyleElement = (insertStyleElement_default());

var Keyboard_svelte_update = injectStylesIntoStyleTag_default()(Keyboard_svelte/* default */.Z, Keyboard_svelte_options);




       /* harmony default export */ const components_Keyboard_svelte = (Keyboard_svelte/* default */.Z && Keyboard_svelte/* default.locals */.Z.locals ? Keyboard_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/Keyboard.svelte
/* src\components\Keyboard.svelte generated by Svelte v3.55.0 */
...
function Keyboard_svelte_get_each_context(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[8] = list[i];
	child_ctx[10] = i;
	return child_ctx;
...
function Keyboard_svelte_get_each_context_1(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[11] = list[i];
	return child_ctx;
}

// (25:8) {#each row as letter (letter)}
function Keyboard_svelte_create_each_block_1(key_1, ctx) {
	let first;
	let keyboardbutton;
	let current;

	keyboardbutton = new src_components_KeyboardButton_svelte({
			props: {
				button: /*letter*/ ctx[11],
				correctPosition: /*checkPosition*/ ctx[2](/*letter*/ ctx[11]),
				correctLetter: /*checkLetter*/ ctx[3](/*letter*/ ctx[11]),
				incorrectLetter: /*checkIncorrect*/ ctx[4](/*letter*/ ctx[11])
			}
		});
	...
	return {
		...
		c() {
			first = empty();
			create_component(keyboardbutton.$$.fragment);
			this.first = first;
		},
		m(target, anchor) {
			insert(target, first, anchor);
			mount_component(keyboardbutton, target, anchor);
			current = true;
		},
		p(new_ctx, dirty) {
			ctx = new_ctx;
		...
		i(local) {
			if (current) return;
			transition_in(keyboardbutton.$$.fragment, local);
			current = true;
		},
		o(local) {
			transition_out(keyboardbutton.$$.fragment, local);
			current = false;
		},
		d(detaching) {
			if (detaching) detach(first);
			destroy_component(keyboardbutton, detaching);
		}
	};
}

// (23:4) {#each rows as row, index (index)}
function Keyboard_svelte_create_each_block(key_1, ctx) {
	let div;
	let each_blocks = [];
	let each_1_lookup = new Map();
	let t;
	...
	const get_key = ctx => /*letter*/ ctx[11];

	for (let i = 0; i < each_value_1.length; i += 1) {
		let child_ctx = Keyboard_svelte_get_each_context_1(ctx, each_value_1, i);
		let key = get_key(child_ctx);
		each_1_lookup.set(key, each_blocks[i] = Keyboard_svelte_create_each_block_1(key, child_ctx));
	}
	...
	return {
		...
		c() {
			...
			t = space();
			attr(div, "class", "row svelte-9qrp3y");
			this.first = div;
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*rows, checkPosition, checkLetter, checkIncorrect*/ 30) {
				each_value_1 = /*row*/ ctx[8];
				group_outros();
				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value_1, each_1_lookup, div, outro_and_destroy_block, Keyboard_svelte_create_each_block_1, t, Keyboard_svelte_get_each_context_1);
				check_outros();
			}
		},
		i(local) {
...
function create_key_block(ctx) {
	...
	for (let i = 0; i < each_value.length; i += 1) {
		let child_ctx = Keyboard_svelte_get_each_context(ctx, each_value, i);
		let key = get_key(child_ctx);
		each_1_lookup.set(key, each_blocks[i] = Keyboard_svelte_create_each_block(key, child_ctx));
	}
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*rows, checkPosition, checkLetter, checkIncorrect*/ 30) {
				...
				group_outros();
				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, section, outro_and_destroy_block, Keyboard_svelte_create_each_block, null, Keyboard_svelte_get_each_context);
				check_outros();
			}
		},
		i(local) {
...
function Keyboard_svelte_create_fragment(ctx) {
	let previous_key = /*keyResults*/ ctx[0];
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*keyResults*/ 1 && safe_not_equal(previous_key, previous_key = /*keyResults*/ ctx[0])) {
				group_outros();
				transition_out(key_block, 1, 1, internal_noop);
				check_outros();
...
function Keyboard_svelte_instance($$self, $$props, $$invalidate) {
	let { keyResults } = $$props;
	...
	const checkPosition = letter => correctPositions.indexOf(letter.label) > -1;
	const checkLetter = letter => correctLetters.indexOf(letter.label) > -1;
	const checkIncorrect = letter => incorrectLetters.indexOf(letter.label) > -1;

	$$self.$$set = $$props => {
		if ('keyResults' in $$props) $$invalidate(0, keyResults = $$props.keyResults);
	};

	return [keyResults, rows, checkPosition, checkLetter, checkIncorrect];
}

class Keyboard extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, Keyboard_svelte_instance, Keyboard_svelte_create_fragment, safe_not_equal, { keyResults: 0 });
	}
}
...
var Game_svelte_options = {};

Game_svelte_options.styleTagTransform = (styleTagTransform_default());
Game_svelte_options.setAttributes = (setAttributesWithoutAttributes_default());

      Game_svelte_options.insert = insertBySelector_default().bind(null, "head");
    
Game_svelte_options.domAPI = (styleDomAPI_default());
Game_svelte_options.insertStyleElement = (insertStyleElement_default());

var Game_svelte_update = injectStylesIntoStyleTag_default()(Game_svelte/* default */.Z, Game_svelte_options);




       /* harmony default export */ const components_Game_svelte = (Game_svelte/* default */.Z && Game_svelte/* default.locals */.Z.locals ? Game_svelte/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/Game.svelte
/* src\components\Game.svelte generated by Svelte v3.55.0 */
...
function Game_svelte_create_key_block(ctx) {
	let main;
	let div;
	let statebutton;
	let t0;
	...
	statebutton = new src_components_StateButton_svelte({
			props: { isInProgress: /*isInProgress*/ ctx[2] }
		});

	concedebutton = new src_components_ConcedeButton_svelte({
			props: { isInProgress: /*isInProgress*/ ctx[2] }
		});

	guesses = new src_components_Guesses_svelte({
			props: {
				guessResults: /*guessResults*/ ctx[0],
				guessIndex: /*guessIndex*/ ctx[1],
				isInProgress: /*isInProgress*/ ctx[2]
			}
		});

	keyboard = new src_components_Keyboard_svelte({
			props: { keyResults: /*keyResults*/ ctx[3] }
		});
	...
	return {
		c() {
			...
			t0 = space();
			create_component(concedebutton.$$.fragment);
			t1 = space();
			create_component(guesses.$$.fragment);
			t2 = space();
			create_component(keyboard.$$.fragment);
			attr(div, "class", "container svelte-k4vp9f");
			attr(main, "class", "svelte-k4vp9f");
		},
		m(target, anchor) {
			...
			append(div, t0);
			mount_component(concedebutton, div, null);
			append(div, t1);
			mount_component(guesses, div, null);
			append(main, t2);
		...
		p(ctx, dirty) {
			...
			if (dirty & /*isInProgress*/ 4) statebutton_changes.isInProgress = /*isInProgress*/ ctx[2];
			statebutton.$set(statebutton_changes);
			const concedebutton_changes = {};
			if (dirty & /*isInProgress*/ 4) concedebutton_changes.isInProgress = /*isInProgress*/ ctx[2];
			concedebutton.$set(concedebutton_changes);
			const guesses_changes = {};
			if (dirty & /*guessResults*/ 1) guesses_changes.guessResults = /*guessResults*/ ctx[0];
			if (dirty & /*guessIndex*/ 2) guesses_changes.guessIndex = /*guessIndex*/ ctx[1];
			if (dirty & /*isInProgress*/ 4) guesses_changes.isInProgress = /*isInProgress*/ ctx[2];
			guesses.$set(guesses_changes);
			const keyboard_changes = {};
			if (dirty & /*keyResults*/ 8) keyboard_changes.keyResults = /*keyResults*/ ctx[3];
			keyboard.$set(keyboard_changes);
		},
		i(local) {
			if (current) return;
			transition_in(statebutton.$$.fragment, local);
			transition_in(concedebutton.$$.fragment, local);
		...
		o(local) {
			...
			transition_out(concedebutton.$$.fragment, local);
		...
		d(detaching) {
			...
			destroy_component(concedebutton);
...
function Game_svelte_create_fragment(ctx) {
	let previous_key = /*guessIndex*/ ctx[1];
	let key_block_anchor;
	let current;
	let key_block = Game_svelte_create_key_block(ctx);
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*guessIndex*/ 2 && safe_not_equal(previous_key, previous_key = /*guessIndex*/ ctx[1])) {
				group_outros();
				transition_out(key_block, 1, 1, internal_noop);
				check_outros();
				key_block = Game_svelte_create_key_block(ctx);
				key_block.c();
				transition_in(key_block, 1);
				key_block.m(key_block_anchor.parentNode, key_block_anchor);
			} else {
...
function Game_svelte_instance($$self, $$props, $$invalidate) {
	...
	const unsubscribe = gameStore.subscribe(() => {
		$$invalidate(0, guessResults = gameStore.getGuesses());
		$$invalidate(1, guessIndex = gameStore.getGuessIndex());
	...
	return [guessResults, guessIndex, isInProgress, keyResults];
}

class Game_svelte_Game extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, Game_svelte_instance, Game_svelte_create_fragment, safe_not_equal, {});
	}
}

/* harmony default export */ const src_components_Game_svelte = (Game_svelte_Game);
...
function create_default_slot(ctx) {
	let game;
	let current;
	game = new src_components_Game_svelte({});
...
function App_svelte_create_fragment(ctx) {
	...
	let modal;
	let current;
	sveltetoast = new svelte_toast_src_SvelteToast_svelte({});
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/global.css
var cjs_js_src_global = __webpack_require__(767);
...
var global_update = injectStylesIntoStyleTag_default()(cjs_js_src_global/* default */.Z, global_options);




       /* harmony default export */ const src_global = (cjs_js_src_global/* default */.Z && cjs_js_src_global/* default.locals */.Z.locals ? cjs_js_src_global/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/main.ts


const app = new App_svelte({ target: document.body });
