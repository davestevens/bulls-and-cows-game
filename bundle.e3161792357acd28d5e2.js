...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "ol.svelte-1r2susz{list-style:none;margin:0.1rem 0;padding:0;position:relative}ol.svelte-1r2susz:before{content:'';display:block;width:0.5rem;height:0.5rem;position:absolute;top:50%;left:-1rem;transform:translateY(-50%);border:solid black;border-width:0 0.15rem 0.15rem 0;display:inline-block;transform:rotate(-45deg);transform-origin:0 0}li.svelte-1r2susz{display:inline-block;width:1.5rem;height:2rem;border:0.1rem solid grey;margin:0 0.1rem;text-align:center;line-height:2rem;vertical-align:middle}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button.svelte-1b8ffk9{position:absolute;left:100%;margin-left:0.5rem;display:flex;align-items:center;justify-content:center;width:2rem;height:2rem;border:none;background-color:transparent;font-size:2em;font-family:inherit}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const validateWord = (word) => words.includes(word);
...
function StateButton_svelte_create_else_block(ctx) {
	let t;
...
// (9:2) {#if isInProgress}
function StateButton_svelte_create_if_block(ctx) {
	let t;
...
function StateButton_svelte_create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*isInProgress*/ ctx[0]) return StateButton_svelte_create_if_block;
		return StateButton_svelte_create_else_block;
	}
	...
	return {
		c() {
			button = internal_element("button");
			if_block.c();
			attr(button, "class", "svelte-1b8ffk9");
		},
		m(target, anchor) {
			insert(target, button, anchor);
			...
			if (!mounted) {
				dispose = listen(button, "click", /*handleReset*/ ctx[1]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
function StateButton_svelte_instance($$self, $$props, $$invalidate) {
	...
	return [isInProgress, handleReset];
}

class StateButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, StateButton_svelte_instance, StateButton_svelte_create_fragment, safe_not_equal, { isInProgress: 0 });
	}
}
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/src/components/Guess.svelte.5.css!./src/components/Guess.svelte
var Guess_svelte = __webpack_require__(478);
;// CONCATENATED MODULE: ./src/components/Guess.svelte.5.css!=!./node_modules/svelte-loader/index.js?cssPath=C:/Users/d4v3u/projects/bulls-and-cows-game/src/components/Guess.svelte.5.css!./src/components/Guess.svelte
...
// (52:2) {#each letters as letter, index}
...
function KeyboardButton_svelte_create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*correctPosition*/ 2) {
				toggle_class(button_1, "position", /*correctPosition*/ ctx[1]);
			}

			if (dirty & /*correctLetter*/ 4) {
				toggle_class(button_1, "letter", /*correctLetter*/ ctx[2]);
			}

			if (dirty & /*incorrectLetter*/ 8) {
				toggle_class(button_1, "incorrect", /*incorrectLetter*/ ctx[3]);
			}
		},
		i: internal_noop,
...
// (19:8) {#each row as letter (letter)}
...
// (17:4) {#each rows as row, index (index)}
...
function Keyboard_svelte_instance($$self, $$props, $$invalidate) {
	...
	const rows = [
		...
		[
			{ label: '↩️', charCode: 13, special: true },
			{ label: 'Z' },
			{ label: 'X' },
			{ label: 'C' },
			{ label: 'V' },
			...
			{ label: 'N' },
			{ label: 'M' },
			{ label: '⬅️', charCode: 8, special: true }
		]
	];
